                    ...
                    onTap: () {
                      model.getContactInfo(context).then((info) {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) =>
                                PrivacyPolicy(info.data.settings.policy)));
                      });
                    },
                    child: customContainer(
                      child: Padding(
                              ...
                              actions: <Widget>[
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    ClippedButton(
                                      color: ColorsD.redDefault,
                                      child: isLoading? Loading(color: ColorsD.redDefault, indicator: BallPulseIndicator(),): TextD(
                                        title: 'التسجيل',
                                        textColor: Colors.white,
                                      ),
                                      onTapCallback:isLoading?null:  () async {
                                        isLoading = true;
                                        setState(() {});
                                        await baseModel
                                            .login(
                                                context, '${phoneCtrler.text}')
                                            .then((user) {
                                          isLoading = false;
                                          setState(() {});
                                          Navigator.pop(context);
