              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.only(right: 8.0),
                    child: TextD(
                      title: 'التجهيز: ${baseModel.packaging.singleWhere((pack) => pack.id == baseModel.allProducts[index]['packaging']).name}',
                      fontSize: 16,
                      height: 0.8,
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(right: 8.0),
                    child: TextD(
                      title: 'التقطيع: ${baseModel.cuts.singleWhere((pack) => pack.id == baseModel.allProducts[index]['Shredder']).name}',
                      fontSize: 16,
                      height: 0.8,
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(right: 8.0),
                    child: TextD(
                      title: 'السعر: ${baseModel.allProducts[index]['price']} ريال سعودى',
            ...
            Align(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  ...
                  pref.setString('products', json.encode(baseModel.allProducts));
                  setState(() {});
                  });
                },
